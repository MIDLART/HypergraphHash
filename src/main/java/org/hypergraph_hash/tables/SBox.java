...
public class SBox {
  ...
  private static final int[] AES_S_BOX = {
  ...
  private static final int[] KUZNYECHIK_S_BOX = {
  ...
  private static final int[] CAMELLIA_S_BOX = {
  ...
  public static int getAES(int index) {
    return AES_S_BOX[index] & 0xFF;
  }

  public static int getKuznyechik(int index) {
    return KUZNYECHIK_S_BOX[index] & 0xFF;
  }
